    ...
    for query in queries:
        ...
        for result in results:
            ...
            try:
                ...
                # Extract location
                location_match = re.search(r'(Dubai|UAE|Saudi|Indiana|Louisiana|Pennsylvania|Texas|Utah|Wyoming|Georgetown|Wichita|Lebanon|Egypt|Moon|Lunar|India|Egypt|Kuwait)', text, re.I)
                location = location_match.group(1) if location_match else "Unknown"

                # Extract sector
                sector = "Unknown"
                lower_text = text.lower()
                if "hotel" in lower_text or "hospitality" in lower_text or "marina" in lower_text:
                    sector = "Hospitality"
